...
mongoose.connect("mongodb+srv://yashsen1007:bso7MeiE0TH1xfVA@instaclonedata.rb1lp7d.mongodb.net/?retryWrites=true&w=majority&appName=InstaCloneData").then(function (result) {
...
try {
  ...
  router.get("/feed", isLoggedIn, async (req, res, next) => {
    ...
    res.render("feed", { allPosts, AllUsers, currentUser, user: req.user, allStories });
  })
  ...
  router.get("/fullStory", isLoggedIn, async (req, res, next) => {
